...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="./index.php?home" class="brand-link">
        <img src="./img/AdminLTELogo.png" alt="Project MVC" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Project MVC</span>
    </a>
